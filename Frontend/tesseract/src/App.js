...
// import MusicNFTMarketplaceAbi from './contractsData/contractsData/MusicNFTMarketplace.json'
// import MusicNFTMarketplaceAddress from './contractsData/contractsData/MusicNFTMarketplace-address.json'
...
function App() {
  ...
  const loadContract = async (signer) => {
    ...
    const contract = new ethers.Contract(tesseractmusic.address, tesseractmusic.abi, signer)
